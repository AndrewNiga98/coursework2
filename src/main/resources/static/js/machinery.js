...
app.controller("AppCtrl", function ($http, $scope) {
    ...
    this.del_entry = function del(id) {
        $http.get('/api/machinery/del?id='+id).then(function (response){
            window.location.reload();
            window.alert('Техніка було успішно видалено!');
        });
    };
    ...
    this.insert_entry = function add() {
        ...
        $http.get('/api/machinery/insert?name='+name).then(function (response){
            window.location.reload();
            window.alert('Техніку було успішно додано!');
        });
    };
    ...
    this.update_entry = function upd() {
        ...
        $http.get('/api/machinery/update?id='+thisId+'&name='+name).then(function (response){
            window.location.reload();
            window.alert('Техніку було успішно змінено!');
        });
    };
