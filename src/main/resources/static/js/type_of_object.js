...
app.controller("AppCtrl", function ($http, $scope) {
    ...
    this.del_entry = function del(id) {
        $http.get('/api/type_of_object/del?id='+id).then(function (response){
            window.location.reload();
            window.alert("Тип об'єкту було успішно видалено!");
        });
    };
    ...
    this.insert_entry = function add() {
        ...
        $http.get('/api/type_of_object/insert?name='+name).then(function (response){
            window.location.reload();
            window.alert('Матеріал було успішно додано!');
        });
    };
    ...
    this.update_entry = function upd() {
        ...
        $http.get('/api/type_of_object/update?id='+thisId+'&name='+name).then(function (response){
            window.location.reload();
            window.alert("Тип об'єкту було успішно змінено!");
        });
    };
