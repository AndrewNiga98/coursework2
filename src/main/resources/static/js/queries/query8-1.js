...
app.controller("AppCtrl", function ($http, $scope) {
    ...
    */
    ...
    $http.get('/api/workers').then(function (response){
        ...
        let selector = document.getElementById("Worker");
        $(selector).empty();
    ...
    $scope.update_request = function add() {
        let workerIndex = document.getElementById("Worker").selectedIndex;
        workerId = document.getElementById("Worker").options[workerIndex].value;
